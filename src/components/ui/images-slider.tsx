...
//       {loading ? (
//         <div>Loading...</div> // Menampilkan pesan loading jika gambar masih dimuat
//       ) : (
//         <img src={loadedImages[currentIndex]} className="image h-full w-full absolute inset-0 object-cover object-center" />
//       )}
//     </div>
//   );
// };
